...
#' @param filename name or full path to the expression matrix file
#' @param rowFormat format of the file. Supported:
#'                    A row is a series of measurements of one gene (TRUE)
#'                    A column is a series of measurements of one gene (FALSE)
#' @param seperator [DEFAULT="\t"] seperator of the values, default tab
#' @param isLabeled [DEFAULT=TRUE] first row or column of file are gene labels.
#' @param labels [DEFAULT=NULL] unique labels for each gene
...
#' @param sampleNames [DEFAULT=FALSE]: indicates whether the first row/col is the name of the sample. In this case, the row/col will be dropped
#' @param normalize [DEFAULT=TRUE] : indicates whether the expression matrix should be normalized
#'
#' @return 	(normalized) expression matrix in format (samples x genes), i.e. every col is a gene
#' @export
#'
#' @examples
constructExpressionMatrixFromFile <- function(filename,
                                              rowFormat = FALSE,
                                              seperator = "\t",
                                              isLabeled = TRUE,
                                              labels = NULL,
